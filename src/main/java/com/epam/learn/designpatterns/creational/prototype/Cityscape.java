package main.java.com.epam.learn.designpatterns.creational.prototype;
...
public class Cityscape {
    public static void main(String[] args) {
        ...
        List<Graphic> order = List.of(house1, house2, house3, house4, house5, skyscraper1, skyscraper2,
                skyscraper3, skyscraper4, skyscraper5);

        createCityscape(order);
    }

    private static void createCityscape(List<Graphic> graphics) {
        System.out.println("Construction cityscape: ");
