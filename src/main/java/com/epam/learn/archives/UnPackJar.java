...
/**
 * Reading a jar archive with UnPackJar.java
 *
 * To specify a path to an archive file and to the directory
 * where decompressed files should be placed,
 * use either an absolute path or one from the root project directory.
 */
